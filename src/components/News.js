...
const News = (props) => {
  ...
  const updateNews = async () => {
    ...
    const url = `https://newsapi.org/v2/top-headlines?country=in&category=${props.category}&apiKey=385b53e5914b4385b91bd13366d71a13&page=${page}&pageSize=${props.PageSize}`;
    setLoading(true);
